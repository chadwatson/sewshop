...
function CartIcon({
  ...
  return (
    <svg
      ...
      width={width}
      fill={active ? activeFillPrimary : fill}
    >
      {active ? (
        <g>
          <circle
            cx="11" cy="5" r="5"
            fill={activeFillSecondary}
            clipPath="url(#cut-off-bottom)"
          />
          <polygon
            points="4 4, 19.25 4, 17 10, 5 10"
            fill={activeFillSecondary}
          />
        </g>
      ) : null}
...
CartIcon.propTypes = {
  ...
  activeFillPrimary: React.PropTypes.string,
  activeFillSecondary: React.PropTypes.string,
};
